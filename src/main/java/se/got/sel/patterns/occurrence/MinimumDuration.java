...
public class MinimumDuration extends Occurrence
{
    ...
    public MinimumDuration( Event aEventP, long aUpperLimit, String aTimeUnit, ProbabilityBound aProbBound )
    {
    ...
    public int getType() 
    {
        return PSPConstants.P_MinimumDuration;
    }
