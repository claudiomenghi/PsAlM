...
public class MissionLibraryRender extends DefaultListCellRenderer {
	...
	public Component getListCellRendererComponent(JList<? extends Object> list, Object value, int index,
		...
		//	File f=  new File(getClass().getClassLoader().("images/"+val.substring(0, val.indexOf(" "))+".png").getPath());
			//if(f.exists()){
			System.out.println("Loading image: "+"images/"+val.substring(0, val.indexOf(" "))+".png");
			icon=new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream(("images/"+val.substring(0, val.indexOf(" "))+".png"))));
			//}
