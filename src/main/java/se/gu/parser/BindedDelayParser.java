...
public class BindedDelayParser extends Parser {
	...
	public static final int
		RULE_bindedDelay = 0, RULE_react = 1, RULE_booleanexp = 2, RULE_unop = 3, 
	...
	public static final String[] ruleNames = {
		"bindedDelay", "react", "booleanexp", "unop", "lop", "atom", "posassignement", 
		"posnumAss", "expression", "function", "operator", "positiveoperator"
	};

	@Override
	public String getGrammarFileName() { return "BindedDelay.g4"; }
	...
	public BindedDelayParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class BindedDelayContext extends ParserRuleContext {
		public ReactContext react() {
			return getRuleContext(ReactContext.class,0);
		}
		public TerminalNode EOF() { return getToken(BindedDelayParser.EOF, 0); }
		public TerminalNode GLOBALLY() { return getToken(BindedDelayParser.GLOBALLY, 0); }
		public BindedDelayContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_bindedDelay; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterBindedDelay(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitBindedDelay(this);
		}
	}

	public final BindedDelayContext bindedDelay() throws RecognitionException {
		BindedDelayContext _localctx = new BindedDelayContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_bindedDelay);
		try {
			setState(34);
	...
	public static class ReactContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterReact(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitReact(this);
		}
	}
	...
	public static class BooleanexpContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterBooleanexp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitBooleanexp(this);
		}
	}
	...
	public static class UnopContext extends ParserRuleContext {
		public TerminalNode NEG() { return getToken(BindedDelayParser.NEG, 0); }
		public TerminalNode NEXT() { return getToken(BindedDelayParser.NEXT, 0); }
		public TerminalNode TEXTUALNEXT() { return getToken(BindedDelayParser.TEXTUALNEXT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterUnop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitUnop(this);
		}
	}
	...
	public static class LopContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterLop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitLop(this);
		}
	}
	...
	public static class AtomContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(BindedDelayParser.ID, 0); }
		public TerminalNode MINUS() { return getToken(BindedDelayParser.MINUS, 0); }
		public TerminalNode CONSTANT() { return getToken(BindedDelayParser.CONSTANT, 0); }
		public TerminalNode NAT() { return getToken(BindedDelayParser.NAT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitAtom(this);
		}
	}
	...
	public static class PosassignementContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(BindedDelayParser.ID); }
		public OperatorContext operator() {
			return getRuleContext(OperatorContext.class,0);
		}
		public TerminalNode ID(int i) {
			return getToken(BindedDelayParser.ID, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterPosassignement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitPosassignement(this);
		}
	}
	...
	public static class PosnumAssContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterPosnumAss(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitPosnumAss(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitExpression(this);
		}
	}
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterFunction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitFunction(this);
		}
	}
	...
	public static class OperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterOperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitOperator(this);
		}
	}
	...
	public static class PositiveoperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).enterPositiveoperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BindedDelayListener ) ((BindedDelayListener)listener).exitPositiveoperator(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\r\2\4\6\22\16\2\4\6\b\n\f\16\20\22\24\26\30\2\6\3\2\22\24\5\2\7\7\n"+
		"\n\27\27\6\2\3\6\b\t\13\13\27\30\6\2\4\4\6\6\t\t\27\27\u00ba\2$\3\2\2"+
		"\2\4&\3\2\2\2\6A\3\2\2\2\bR\3\2\2\2\nT\3\2\2\2\f[\3\2\2\2\16]\3\2\2\2"+
		"\20a\3\2\2\2\22t\3\2\2\2\24\u008f\3\2\2\2\26\u00ab\3\2\2\2\30\u00ad\3"+
		"\2\2\2\32\33\7\r\2\2\33\34\5\4\3\2\34\35\7\2\2\3\35%\3\2\2\2\36\37\7\r"+
		"\2\2\37 \7\25\2\2 !\5\4\3\2!\"\7\26\2\2\"#\7\2\2\3#%\3\2\2\2$\32\3\2\2"+
		"\2$\36\3\2\2\2%\3\3\2\2\2&\'\5\6\4\2\'(\7\f\2\2()\5\6\4\2)\5\3\2\2\2*"+
		"+\b\4\1\2+,\5\b\5\2,-\5\6\4\t-B\3\2\2\2./\7\25\2\2/\60\5\6\4\2\60\61\7"+
		"\26\2\2\61B\3\2\2\2\62\63\7\25\2\2\63\64\5\6\4\2\64\65\7\26\2\2\65\66"+
