...
public class InstantaneousReactionParser extends Parser {
	...
	public static final int
		RULE_instantaneousReactionPattern = 0, RULE_react = 1, RULE_booleanexp = 2, 
		RULE_unop = 3, RULE_lop = 4, RULE_atom = 5, RULE_posassignement = 6, RULE_posnumAss = 7, 
		RULE_expression = 8, RULE_function = 9, RULE_operator = 10, RULE_positiveoperator = 11;
	public static final String[] ruleNames = {
		"instantaneousReactionPattern", "react", "booleanexp", "unop", "lop", 
		"atom", "posassignement", "posnumAss", "expression", "function", "operator", 
		"positiveoperator"
	};

	@Override
	public String getGrammarFileName() { return "InstantaneousReaction.g4"; }
	...
	public InstantaneousReactionParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class InstantaneousReactionPatternContext extends ParserRuleContext {
		public ReactContext react() {
			return getRuleContext(ReactContext.class,0);
		}
		public TerminalNode EOF() { return getToken(InstantaneousReactionParser.EOF, 0); }
		public TerminalNode GLOBALLY() { return getToken(InstantaneousReactionParser.GLOBALLY, 0); }
		public InstantaneousReactionPatternContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_instantaneousReactionPattern; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterInstantaneousReactionPattern(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitInstantaneousReactionPattern(this);
		}
	}

	public final InstantaneousReactionPatternContext instantaneousReactionPattern() throws RecognitionException {
		InstantaneousReactionPatternContext _localctx = new InstantaneousReactionPatternContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_instantaneousReactionPattern);
		try {
			setState(34);
	...
	public static class ReactContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterReact(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitReact(this);
		}
	}
	...
	public static class BooleanexpContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterBooleanexp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitBooleanexp(this);
		}
	}
	...
	public static class UnopContext extends ParserRuleContext {
		public TerminalNode NEG() { return getToken(InstantaneousReactionParser.NEG, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterUnop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitUnop(this);
		}
	}
	...
	public static class LopContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterLop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitLop(this);
		}
	}
	...
	public static class AtomContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(InstantaneousReactionParser.ID, 0); }
		public TerminalNode MINUS() { return getToken(InstantaneousReactionParser.MINUS, 0); }
		public TerminalNode CONSTANT() { return getToken(InstantaneousReactionParser.CONSTANT, 0); }
		public TerminalNode NAT() { return getToken(InstantaneousReactionParser.NAT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitAtom(this);
		}
	}
	...
	public static class PosassignementContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(InstantaneousReactionParser.ID); }
		public OperatorContext operator() {
			return getRuleContext(OperatorContext.class,0);
		}
		public TerminalNode ID(int i) {
			return getToken(InstantaneousReactionParser.ID, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterPosassignement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitPosassignement(this);
		}
	}
	...
	public static class PosnumAssContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterPosnumAss(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitPosnumAss(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitExpression(this);
		}
	}
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterFunction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitFunction(this);
		}
	}
	...
	public static class OperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterOperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitOperator(this);
		}
	}
	...
	public static class PositiveoperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).enterPositiveoperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InstantaneousReactionListener ) ((InstantaneousReactionListener)listener).exitPositiveoperator(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\7\r\2\2\33\34\5\4\3\2\34\35\7\2\2\3\35%\3\2\2\2\36\37\7\r\2\2\37 \7\25"+
		"\2\2 !\5\4\3\2!\"\7\26\2\2\"#\7\2\2\3#%\3\2\2\2$\32\3\2\2\2$\36\3\2\2"+
		"\2%\3\3\2\2\2&\'\5\6\4\2\'(\7\3\2\2()\5\6\4\2)\5\3\2\2\2*+\b\4\1\2+,\5"+
		"\b\5\2,-\5\6\4\t-B\3\2\2\2./\7\25\2\2/\60\5\6\4\2\60\61\7\26\2\2\61B\3"+
		"\2\2\2\62\63\7\25\2\2\63\64\5\6\4\2\64\65\7\26\2\2\65\66\5\n\6\2\66\67"+
		"\5\6\4\2\67B\3\2\2\289\7\25\2\29:\5\6\4\2:;\7\26\2\2;<\5\n\6\2<=\7\25"+
