...
public class InitParser extends Parser {
	...
	public static final int
		RULE_init = 0, RULE_f = 1, RULE_unop = 2, RULE_atom = 3, RULE_posassignement = 4, 
		RULE_posnumAss = 5, RULE_expression = 6, RULE_lop = 7, RULE_function = 8, 
		RULE_operator = 9, RULE_positiveoperator = 10;
	public static final String[] ruleNames = {
		"init", "f", "unop", "atom", "posassignement", "posnumAss", "expression", 
	...
	public static class InitContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterInit(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitInit(this);
		}
	}
	...
	public static class FContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterF(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitF(this);
		}
	}
	...
	public static class UnopContext extends ParserRuleContext {
		public TerminalNode NEG() { return getToken(InitParser.NEG, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterUnop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitUnop(this);
		}
	}
	...
	public static class AtomContext extends ParserRuleContext {
		...
		public TerminalNode CONSTANT() { return getToken(InitParser.CONSTANT, 0); }
		public TerminalNode NAT() { return getToken(InitParser.NAT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitAtom(this);
		}
	}
	...
	public static class PosassignementContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterPosassignement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitPosassignement(this);
		}
	}
	...
	public static class PosnumAssContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterPosnumAss(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitPosnumAss(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitExpression(this);
		}
	}
	...
	public static class LopContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterLop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitLop(this);
		}
	}
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterFunction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitFunction(this);
		}
	}
	...
	public static class OperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterOperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitOperator(this);
		}
	}
	...
	public static class PositiveoperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).enterPositiveoperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof InitListener ) ((InitListener)listener).exitPositiveoperator(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\n\3\n\5\n\u008d\n\n\3\n\3\n\3\n\5\n\u0092\n\n\3\n\3\n\3\n\3\n\3\n\5"+
		"\n\u0099\n\n\7\n\u009b\n\n\f\n\16\n\u009e\13\n\3\n\3\n\3\13\3\13\3\f\3"+
		"\f\3\f\2\4\4\16\r\2\4\6\b\n\f\16\20\22\24\26\2\5\b\2\3\4\t\t\13\13\r\r"+
		"\17\17\32\32\7\2\5\b\n\n\f\f\16\16\32\33\6\2\6\6\b\b\f\f\32\32\u00b1\2"+
		"\30\3\2\2\2\4\67\3\2\2\2\6H\3\2\2\2\bO\3\2\2\2\nQ\3\2\2\2\fU\3\2\2\2\16"+
		"h\3\2\2\2\20\u0083\3\2\2\2\22\u0085\3\2\2\2\24\u00a1\3\2\2\2\26\u00a3"+
		"\3\2\2\2\30\31\5\4\3\2\31\32\7\2\2\3\32\3\3\2\2\2\33\34\b\3\1\2\34\35"+
		"\5\6\4\2\35\36\5\4\3\t\368\3\2\2\2\37 \7\30\2\2 !\5\4\3\2!\"\7\31\2\2"+
		"\"8\3\2\2\2#$\5\6\4\2$%\7\30\2\2%&\5\4\3\2&\'\7\31\2\2\'8\3\2\2\2()\7"+
		"\30\2\2)*\5\4\3\2*+\7\31\2\2+,\5\20\t\2,-\5\4\3\2-8\3\2\2\2./\7\30\2\2"+
		"/\60\5\4\3\2\60\61\7\31\2\2\61\62\5\20\t\2\62\63\7\30\2\2\63\64\5\4\3"+
