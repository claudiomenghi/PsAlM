...
public class FastReactionParser extends Parser {
	...
	public static final int
		RULE_fastReaction = 0, RULE_react = 1, RULE_booleanexp = 2, RULE_unop = 3, 
	...
	public static final String[] ruleNames = {
		"fastReaction", "react", "booleanexp", "unop", "ltl", "f", "atom", "posassignement", 
		"posnumAss", "expression", "lop", "function", "operator", "positiveoperator"
	};

	@Override
	public String getGrammarFileName() { return "FastReaction.g4"; }
	...
	public FastReactionParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class FastReactionContext extends ParserRuleContext {
		public ReactContext react() {
			return getRuleContext(ReactContext.class,0);
		}
		public TerminalNode EOF() { return getToken(FastReactionParser.EOF, 0); }
		public TerminalNode GLOBALLY() { return getToken(FastReactionParser.GLOBALLY, 0); }
		public FastReactionContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_fastReaction; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterFastReaction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitFastReaction(this);
		}
	}

	public final FastReactionContext fastReaction() throws RecognitionException {
		FastReactionContext _localctx = new FastReactionContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_fastReaction);
		try {
			setState(38);
	...
	public static class ReactContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterReact(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitReact(this);
		}
	}
	...
	public static class BooleanexpContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterBooleanexp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitBooleanexp(this);
		}
	}
	...
	public static class UnopContext extends ParserRuleContext {
		public TerminalNode NEG() { return getToken(FastReactionParser.NEG, 0); }
		public TerminalNode NEXT() { return getToken(FastReactionParser.NEXT, 0); }
		public TerminalNode TEXTUALNEXT() { return getToken(FastReactionParser.TEXTUALNEXT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterUnop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitUnop(this);
		}
	}
	...
	public final UnopContext unop() throws RecognitionException {
		...
		try {
			...
			setState(84);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NEXT) | (1L << TEXTUALNEXT) | (1L << NEG))) != 0)) ) {
	...
	public static class LtlContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterLtl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitLtl(this);
		}
	}
	...
	public static class FContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterF(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitF(this);
		}
	}
	...
	public static class AtomContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(FastReactionParser.ID, 0); }
		public TerminalNode MINUS() { return getToken(FastReactionParser.MINUS, 0); }
		public TerminalNode CONSTANT() { return getToken(FastReactionParser.CONSTANT, 0); }
		public TerminalNode NAT() { return getToken(FastReactionParser.NAT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitAtom(this);
		}
	}
	...
	public static class PosassignementContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(FastReactionParser.ID); }
		public OperatorContext operator() {
			return getRuleContext(OperatorContext.class,0);
		}
		public TerminalNode ID(int i) {
			return getToken(FastReactionParser.ID, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterPosassignement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitPosassignement(this);
		}
	}
	...
	public static class PosnumAssContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterPosnumAss(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitPosnumAss(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).enterExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FastReactionListener ) ((FastReactionListener)listener).exitExpression(this);
		}
	}
	...
	public static class LopContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instance